...
const LandingPage = () => {
    return (
        <div>
            ...
            >
                <div className=' p-10 '>
                    <img src={arizo} alt="logo" className=' rounded-lg' style={{ width: '150px' }} />
                </div>

                <div className='flex justify-between p-3'>
                    <div className=' p-8 w-full md:w-1/2 text-white'>
                        <p className='py-4'>Welcome Arizona chipping</p>
                        <p className='text-xl md:text-2xl'>Please select location you are ordering from</p>
                        <form className='py-8 md:py-4'>
                            <select className='p-3 rounded-md focus:bg-[#d9b348] text-sm text-gray-400 w-full'>
